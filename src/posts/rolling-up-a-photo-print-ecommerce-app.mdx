...
I had other problems though. What to build? And how to build it?
...
Below is a rough pseudocode outline of the models I created:
...
# I have left those in in case I expand on the project someday with things like frame options
```
